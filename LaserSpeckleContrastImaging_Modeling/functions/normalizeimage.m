function [normalizedImage] = normalizeimage(sumImages,targetMean,targetK,stdparenchyma)
...
for i =1:3
normalizedI(:,:,i) = round( targetMean + (((sumImages(:,:,i) - mean(sumImages(:,:,i),'all'))./stdparenchyma(i))*targetSTD));
